...
const Schema: z.ZodType<Prisma.PositionUncheckedUpdateManyWithoutCompanyNestedInput> = z
	.object({
		create: z
			.union([
...
export const PositionUncheckedUpdateManyWithoutCompanyNestedInputObjectSchema = Schema;
