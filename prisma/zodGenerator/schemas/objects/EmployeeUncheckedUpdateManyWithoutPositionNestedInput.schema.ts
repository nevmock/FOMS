...
const Schema: z.ZodType<Prisma.EmployeeUncheckedUpdateManyWithoutPositionNestedInput> = z
	.object({
		create: z
			.union([
...
export const EmployeeUncheckedUpdateManyWithoutPositionNestedInputObjectSchema = Schema;
