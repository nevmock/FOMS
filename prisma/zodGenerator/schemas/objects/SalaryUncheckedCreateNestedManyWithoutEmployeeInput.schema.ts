...
const Schema: z.ZodType<Prisma.SalaryUncheckedCreateNestedManyWithoutEmployeeInput> = z
	.object({
		create: z
			.union([
...
export const SalaryUncheckedCreateNestedManyWithoutEmployeeInputObjectSchema = Schema;
