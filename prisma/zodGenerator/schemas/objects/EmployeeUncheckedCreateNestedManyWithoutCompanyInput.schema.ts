...
const Schema: z.ZodType<Prisma.EmployeeUncheckedCreateNestedManyWithoutCompanyInput> = z
	.object({
		create: z
			.union([
...
export const EmployeeUncheckedCreateNestedManyWithoutCompanyInputObjectSchema = Schema;
