...
const Schema: z.ZodType<Prisma.EmployeeUpdateManyWithWhereWithoutPositionInput> = z
	.object({
...
export const EmployeeUpdateManyWithWhereWithoutPositionInputObjectSchema = Schema;
