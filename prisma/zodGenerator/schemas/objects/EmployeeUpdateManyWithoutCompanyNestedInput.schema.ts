...
const Schema: z.ZodType<Prisma.EmployeeUpdateManyWithoutCompanyNestedInput> = z
	.object({
		create: z
			.union([
...
export const EmployeeUpdateManyWithoutCompanyNestedInputObjectSchema = Schema;
