...
const Schema: z.ZodType<Prisma.PositionUncheckedCreateNestedManyWithoutCompanyInput> = z
	.object({
		create: z
			.union([
...
export const PositionUncheckedCreateNestedManyWithoutCompanyInputObjectSchema = Schema;
