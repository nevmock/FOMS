...
const Schema: z.ZodType<Prisma.EmployeeUncheckedCreateNestedManyWithoutPositionInput> = z
	.object({
		create: z
			.union([
...
export const EmployeeUncheckedCreateNestedManyWithoutPositionInputObjectSchema = Schema;
